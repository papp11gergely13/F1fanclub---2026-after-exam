...
<head>
    ...
    <title>Időmérő Eredmények - F1 Fan Club</title>
        ...
        <div class="championship-content full-width">
            ...
            <div class="control-panel">
                <div class="panel-header">
                    ...
                    <h2>IDŐMÉRŐ <span>EREDMÉNYEK</span></h2>
                </div>
                ...
                <div class="current-selection">
                    <div class="selection-info">
                        ...
                        <span class="selection-type">
                            <span id="selectedType">IDŐMÉRŐ</span> SZEZON
                        </span>
                    </div>
            ...
            <div class="standings-card">
                <div class="table-header">
                    <h2>
                        ...
                        <span id="tableTitle">IDŐMÉRŐ EREDMÉNYEK</span>
                    </h2>
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', () => {
            ...
            function loadQualifying(year, round, raceName) {
                ...
                tableTitle.innerHTML = `${cleanRaceName} <span style="color:#666;">|</span> IDŐMÉRŐ`;

                standingsBody.innerHTML = '<tr><td colspan="6" class="loading-message"><i class="fas fa-circle-notch fa-spin"></i> Időmérő adatok betöltése...</td></tr>';
                ...
                fetch(`https://api.jolpi.ca/ergast/f1/${year}/${round}/qualifying.json`)
                    ...
                    .then(data => {
                        ...
                        list.forEach(q => {
                            ...
                            const teamName = q.Constructor?.name || "Ismeretlen";
                            const teamColor = getTeamColorJS(teamName);
                            
                            const rowClass = isPole ? 'f1-champion' : '';
                            ...
                            html += `
                                <tr class="${rowClass}" style="background: ${gradientStyle};">
                                    <td class="f1-pos" ${isPole ? 'style="color:#d4af37;"' : ''}>${q.position}</td>
                                    ...
                                    <td style="text-align:center; ${isPole ? 'color:#d4af37;' : 'color:#e10600;'}">${q3}</td>
                                </tr>
                            `;
                        });
